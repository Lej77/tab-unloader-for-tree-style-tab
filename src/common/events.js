 ...
 *
 * @class EventListener
 * @template {any[]} T Arguments for event listeners.
 * @template R Return value of event listeners.
 * @template E Extra data provided when adding a listener.
 *
 * @template {EventTarget | EventSubscriber<T, R, E>} A The DOM element of event subscriber we are listening to.
// @ts-ignore
